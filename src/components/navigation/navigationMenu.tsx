    ...
    <li {...props}>
      <NavigationMenuLink asChild>
        <Link className=" " href={href}>
          <div className="text- text-sm leading-none font-medium">{title}</div>
          <p className="text- line-clamp-2 text-sm leading-snug">{children}</p>
        </Link>
      </NavigationMenuLink>
    </li>
  );
          ...
          <NavigationMenuContent className="border-none">
            <ul className="grid gap-2 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
              <li className="row-span-3">
                <NavigationMenuLink asChild>
                  <Link
                    className="from-primary/50 to-secondary flex h-full w-full flex-col justify-end rounded-md bg-linear-to-b p-6 no-underline outline-hidden select-none focus:shadow-md"
                    href="/"
                  >
